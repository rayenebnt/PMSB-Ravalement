...
import s from "./RealisationsRail.module.css";

/* ══════════════════════════════════════════════════════════════
   Rail plat des chantiers.

   C'est la variante sans WebGL du mur en 3D : même sélection, même
   lecture, sans contexte graphique. Le défilement est celui du
   navigateur — le doigt, le pavé tactile et le clavier fonctionnent
   sans code, et Lenis laisse passer les gestes horizontaux.
   ══════════════════════════════════════════════════════════════ */

export default function RealisationsRail() {
